    ...
    <div className="fixed top-24 right-4 z-50 max-w-md w-full animate-slide-in">
      <div
        className={`rounded-2xl p-6 shadow-2xl border-4 backdrop-blur-xl ${
          type === 'success' ? 'bg-[#f2ebeb] border-green-600' : 'bg-[#f2ebeb] border-[#00843D]'
        }`}
      >
        <div className="flex items-start gap-4">
          <div
            className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
              type === 'success' ? 'bg-green-600/20' : 'bg-[#00843D]/20'
            }`}
          >
            {type === 'success' ? (
          ...
          <button
            ...
            className="flex-shrink-0 text-[#0a0a0c]/40 hover:text-[#00843D] transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
...
const SuccessPopup = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md animate-fade-in p-4">
      <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-8 md:p-12 max-w-md w-full shadow-2xl text-center animate-scale-up">
        ...
        <p className="text-[#00843D] font-bold text-sm leading-relaxed mb-6">
        ...
        <div className="bg-[#0a0a0c] rounded-2xl border border-white/5 p-5 mb-6 text-left">
          ...
          <ul className="space-y-2 text-sm text-[#FFFFFF]/80 font-bold uppercase tracking-wide">
            <li className="flex items-center gap-2">
              <Check className="w-4 h-4 text-[#FFCD00] shrink-0" />
        ...
        <button
          onClick={onClose}
          className="w-full py-4 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:bg-[#006A31] transition-transform hover:scale-105 shadow-md cursor-pointer border border-[#FFCD00]/30"
        >
          Got it
        </button>
      </div>
...
export default function SupportPage() {
  ...
  const startWhatsAppChat = () => {
    const defaultText = encodeURIComponent(
      `G'day ${BRAND}, I have a question about your IPTV Australia subscription.`
    );
    ...
    '@graph': [
      {
        ...
        url: PAGE_URL,
        name: `${BRAND} Support`,
        description: `Contact ${BRAND} for 24/7 customer support. WhatsApp, email, and live chat help for Australia IPTV subscriptions, setup, and billing.`,
        inLanguage: 'en-AU',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: `For the fastest support, send a message on WhatsApp. Our team typically replies within a few minutes.`,
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Our team guides you step by step through setting up IPTV Australia on Smart TV, Firestick, Android, and Apple TV, either manually or with remote activation on WhatsApp.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Absolutely. Request a free 24 hour IPTV trial via WhatsApp to try our 4K channels risk free before subscribing.',
            },
          },
          {
            '@type': 'Question',
            name: 'How fast will I get set up?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Once you confirm your plan and complete payment, our team sets you up live on WhatsApp. Most customers are streaming within 10 minutes.',
            },
          },
        ],
      },
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] pt-32 pb-16 text-[#FFFFFF]">
      ...
      <section className="relative px-6 pb-16 md:pb-24 overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_rgba(0,132,61,0.15),_transparent_50%)] pointer-events-none" />
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <FadeIn>
              <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-6 md:p-8 shadow-2xl">
                <h2 className="text-2xl md:text-3xl font-black text-[#0a0a0c] uppercase tracking-tight mb-2">
                  Send Us a Message
                </h2>
                <p className="text-[#00843D] font-bold text-sm mb-6">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    >
                      Full Name <span className="text-[#00843D]">*</span>
                    </label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-12 pr-4 py-3.5 bg-black/[0.03] border-2 border-[#0a0a0c]/10 rounded-xl text-[#0a0a0c] font-bold placeholder-[#0a0a0c]/40 focus:border-[#00843D] transition-colors outline-none"
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-black text-[#0a0a0c] uppercase tracking-wide mb-2"
                    >
                      Email Address <span className="text-[#00843D]">*</span>
                    </label>
                    <div className="relative">
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-black text-[#0a0a0c] uppercase tracking-wide mb-2"
                    >
                      Subject <span className="text-[#00843D]">*</span>
                    </label>
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-12 pr-10 py-3.5 bg-black/[0.03] border-2 border-[#0a0a0c]/10 rounded-xl text-[#0a0a0c] font-bold focus:border-[#00843D] transition-colors outline-none appearance-none"
                      >
                        ...
                        <option value="billing" className="bg-[#f2ebeb]">
                          Payments (PayID / Credit Card / PayPal / Crypto)
                        </option>
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-black text-[#0a0a0c] uppercase tracking-wide mb-2"
                    >
                      Message <span className="text-[#00843D]">*</span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="message"
                        ...
                        required
                        rows={5}
                        className="w-full px-4 py-3.5 bg-black/[0.03] border-2 border-[#0a0a0c]/10 rounded-xl text-[#0a0a0c] font-bold placeholder-[#0a0a0c]/40 focus:border-[#00843D] transition-colors outline-none resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-4 rounded-xl bg-gradient-to-r from-[#00843D] to-[#006A31] text-[#FFFFFF] font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-3 border border-[#FFCD00]/30 ${
                      loading
          ...
          <div className="lg:col-span-1">
            <FadeIn>
              <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-6 md:p-8 shadow-2xl space-y-6">
                <h3 className="text-xl font-black text-[#0a0a0c] uppercase tracking-tight mb-6">
                  Contact Details
                </h3>

                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#0a0a0c] hover:text-[#00843D] transition-colors text-sm font-bold break-all"
                    >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#0a0a0c] hover:text-[#00843D] transition-colors text-sm font-bold"
                    >
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center">
                    <MessageSquare className="w-6 h-6 text-[#00843D]" />
                  </div>
                  <div>
                    ...
                    <button
                      ...
                      className="text-[#00843D] text-xs font-black uppercase tracking-widest hover:text-[#006A31] transition-colors mt-1 cursor-pointer block"
                    >
                      Start WhatsApp Chat →
                    </button>
                  </div>
                ...
                <div className="pt-6 border-t-2 border-black/5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-black/5 rounded-xl p-3 text-center border border-black/5">
                      <Headphones className="w-5 h-5 text-[#00843D] mx-auto mb-1" />
                      <p className="text-[#0a0a0c] text-[9px] uppercase font-black tracking-wider">
                        24/7 Help
                      </p>
                    </div>
                    <div className="bg-black/5 rounded-xl p-3 text-center border border-black/5">
                      <ShieldCheck className="w-5 h-5 text-[#00843D] mx-auto mb-1" />
                      <p className="text-[#0a0a0c] text-[9px] uppercase font-black tracking-wider">
                        Secure
                      </p>
                    </div>
                    <div className="bg-black/5 rounded-xl p-3 text-center border border-black/5">
                      <Zap className="w-5 h-5 text-[#00843D] mx-auto mb-1" />
                      <p className="text-[#0a0a0c] text-[9px] uppercase font-black tracking-wider">
                        Fast Setup
                      </p>
                    </div>
                    <div className="bg-black/5 rounded-xl p-3 text-center border border-black/5">
                      <Users className="w-5 h-5 text-[#00843D] mx-auto mb-1" />
                      <p className="text-[#0a0a0c] text-[9px] uppercase font-black tracking-wider">
                        15K+ Customers
                      </p>
                    </div>
        ...
        <FadeIn>
          <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-8 md:p-10 shadow-2xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center mx-auto mb-3">
                  <LifeBuoy className="w-6 h-6 text-[#00843D]" />
                </div>
              ...
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center mx-auto mb-3">
                  <Zap className="w-6 h-6 text-[#00843D]" />
                </div>
                <h4 className="text-[#0a0a0c] font-black text-sm uppercase tracking-wide">
                  Fast Response
                </h4>
              ...
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center mx-auto mb-3">
                  <ShieldCheck className="w-6 h-6 text-[#00843D]" />
                </div>
                <h4 className="text-[#0a0a0c] font-black text-sm uppercase tracking-wide">
                  Privacy Guarantee
                </h4>
              ...
              <div>
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center mx-auto mb-3">
                  <CheckCircle2 className="w-6 h-6 text-[#00843D]" />
                </div>
                <h4 className="text-[#0a0a0c] font-black text-sm uppercase tracking-wide">
                  Best Service
                </h4>
                <p className="text-[#0a0a0c]/60 text-xs font-bold mt-0.5">#1 IPTV Australia</p>
              </div>
            </div>
          </div>
        </FadeIn>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 w-full">
          ...
          {[
            {
              ...
              a: `For the fastest support, message us directly on WhatsApp. Our team typically replies within a few minutes.`,
            },
            {
              q: 'Do you offer help with installation?',
              a: 'Yes. Our team guides you step by step through setting up IPTV Australia on Smart TV, Firestick, Android, and Apple TV, either manually or with remote activation on WhatsApp.',
            },
            {
              q: 'Can I request a free trial first?',
              a: 'Absolutely. Request a free 24 hour IPTV trial via WhatsApp to try our 4K channels risk free before subscribing.',
            },
            {
              q: 'How fast will I get set up?',
              a: 'Once you confirm your plan and complete payment, our team sets you up live on WhatsApp. Most customers are streaming within 10 minutes.',
            },
          ].map((faq, idx) => (
            <FadeInItem
              key={idx}
              className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-2xl p-6 shadow-xl transition-all hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,132,61,0.2)]"
            >
        ...
        <FadeIn className="text-center mt-12">
          <Link
            href="/faq"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-lg border border-[#FFCD00]/30"
          >
            View Full FAQ
          </Link>
        </FadeIn>
