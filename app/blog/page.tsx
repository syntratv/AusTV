...
// ---------------------------------------------------------------------------
// SEO STRINGS — Title 50–59, Description 120–130
// ---------------------------------------------------------------------------
const PAGE_TITLE = clampTitle(
  `IPTV Australia Blog | Setup Guides, Tips & News 2026`
);

const PAGE_DESCRIPTION = clampDescription(
  `IPTV Australia blog with setup guides, app reviews, and streaming tips for Firestick, Smart TV and mobile. Updated weekly with fresh news.`
);
...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BRAND} Blog - IPTV Australia Setup Guides and Streaming Tips`,
      },
    ],
  },
  twitter: {
  ...
  keywords: [
    ...
    'best iptv australia',
    'iptv australia',
    'iptv setup guide australia',
    'iptv firestick setup',
    'ibo player pro guide',
    'iptv reviews australia',
    'iptv subscription australia',
    '4k iptv australia',
    'iptv smart tv guide',
    'streaming tips australia',
    'iptv news 2026',
  ],
};
    ...
    '@graph': [
      {
        ...
        '@id': `${PAGE_URL}/#blog`,
        name: `${BRAND} Blog`,
        description: `Setup guides, reviews, and IPTV Australia tips for Firestick, Smart TV, and mobile streaming.`,
        url: PAGE_URL,
        inLanguage: 'en-AU',
...
function BlogCard({ post, priority = false }: { post: any; priority?: boolean }) {
  ...
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group relative flex flex-col bg-[#f2ebeb] rounded-3xl overflow-hidden border-2 border-[#00843D]/20 hover:border-[#00843D] hover:shadow-[0_20px_50px_rgba(0,132,61,0.2)] hover:-translate-y-2 transition-all duration-500"
    >
      <div className="relative aspect-[16/10] overflow-hidden bg-[#0a0a0c]">
        <Image
          src={post.image}
          alt={`${post.title} - IPTV Australia blog`}
          width={800}
          height={500}
          priority={priority}
        ...
        <div className="absolute top-3 left-3 z-10">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#00843D] text-[#FFFFFF] text-[10px] font-black uppercase tracking-wider shadow-lg">
      ...
      <div className="flex flex-col flex-1 p-5 md:p-6">
        ...
        <h3 className="text-base md:text-lg font-black text-[#0a0a0c] uppercase tracking-tight leading-snug mb-3 line-clamp-2 group-hover:text-[#00843D] transition-colors">
          {post.title}
        </h3>
        ...
        <div className="pt-4 border-t border-[#0a0a0c]/10 flex items-center justify-between">
          <span className="inline-flex items-center gap-1.5 text-[#00843D] font-black text-xs uppercase tracking-widest group-hover:gap-2.5 transition-all">
            Read Article
            <ArrowRight className="w-3.5 h-3.5" />
          </span>
          <div className="w-8 h-8 rounded-xl bg-[#00843D]/10 border border-[#00843D]/30 flex items-center justify-center text-[#00843D] group-hover:bg-[#00843D] group-hover:text-[#FFFFFF] transition-all duration-300">
...
function FeaturedCard({ post }: { post: any }) {
  ...
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group relative grid grid-cols-1 lg:grid-cols-2 gap-0 bg-[#f2ebeb] rounded-[2rem] overflow-hidden border-2 border-[#00843D] hover:shadow-[0_25px_60px_rgba(0,132,61,0.25)] transition-all duration-500"
    >
      <div className="relative aspect-[16/10] lg:aspect-auto lg:min-h-[420px] overflow-hidden bg-[#0a0a0c]">
        <Image
          src={post.image}
          alt={`${post.title} - Featured IPTV Australia article`}
          width={900}
          height={600}
          priority
          loading="eager"
        ...
        <div className="absolute top-4 left-4 z-10">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#00843D] text-[#FFFFFF] text-[11px] font-black uppercase tracking-widest shadow-xl border border-[#FFCD00]/40">
      ...
      <div className="flex flex-col justify-center p-6 md:p-8 lg:p-10">
        <div className="flex flex-wrap items-center gap-2 text-[11px] font-black uppercase tracking-wider text-[#0a0a0c]/60 mb-4">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#00843D]/10 text-[#00843D] border border-[#00843D]/30">
            <Tag className="w-3 h-3" />
            {categoryLabel}
          </span>
        ...
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-[#0a0a0c] uppercase tracking-tight leading-tight mb-4 group-hover:text-[#00843D] transition-colors">
          {post.title}
        </h2>
        ...
        <div className="flex items-center gap-4">
          <span className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-xs uppercase tracking-widest group-hover:gap-3 transition-all shadow-lg border border-[#FFCD00]/30">
            Read Full Article
            <ArrowRight className="w-4 h-4" />
          </span>
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen bg-[#0a0a0c] text-[#FFFFFF]">
        ...
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-[#00843D]/10 blur-[150px] rounded-full pointer-events-none" />
          <div
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none text-[#FFFFFF] mb-6">
              IPTV AUSTRALIA <br />
              <span className="text-[#FFCD00]">BLOG & GUIDES</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl text-[#FFFFFF]/70 font-bold max-w-2xl mx-auto leading-relaxed mb-8">
              Setup guides, app reviews, streaming tips, and the latest news. Everything you need to get the most out of your IPTV Australia subscription.
            </p>
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-full text-xs font-black uppercase tracking-widest transition-all border-2 ${
                  cat.id === 'all'
                    ? 'bg-[#00843D] text-[#FFFFFF] border-[#00843D] shadow-lg shadow-[#00843D]/30'
                    : 'bg-[#f2ebeb]/5 text-[#FFFFFF]/70 border-white/10 hover:bg-[#00843D]/10 hover:text-[#FFFFFF] hover:border-[#00843D]/40'
                }`}
        ...
        {featuredPost && (
          <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full mb-16">
            <div className="mb-6 flex items-center gap-3">
              <div className="h-1 w-12 bg-[#00843D] rounded-full" />
            ...
            <div className="mt-12 flex items-center justify-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-full text-xs font-black transition-all ${
                    idx === 0
                      ...
                      : 'bg-[#f2ebeb]/5 text-[#FFFFFF]/70 border border-white/10 hover:bg-[#00843D]/10 hover:text-[#FFFFFF] hover:border-[#00843D]/40'
                  }`}
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-black uppercase tracking-widest transition-all ${
                  totalPages > 1
                    ? 'bg-[#00843D]/10 text-[#00843D] border border-[#00843D]/40 hover:bg-[#00843D] hover:text-[#FFFFFF] cursor-pointer'
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full mb-16">
          <div className="relative rounded-3xl overflow-hidden border-2 border-[#FFCD00]/30 bg-gradient-to-br from-[#00843D] via-[#006A31] to-[#00843D] p-8 md:p-10 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 bg-[#FFCD00] text-[#006A31] px-4 py-2 rounded-full mb-5 shadow-lg">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#FFFFFF] uppercase tracking-tighter leading-tight mb-4">
                Get Free IPTV Australia Setup Help
              </h3>
              <p className="text-[#FFFFFF]/90 text-sm sm:text-base font-bold max-w-xl mx-auto mb-6">
                Our team is on WhatsApp 24/7 to help with Firestick, Smart TV, or any device. Guided IBO Player Pro activation included.
              </p>
              <a
                href={`${CONSTANTS.CONTACT.whatsappUrl}?text=${encodeURIComponent(
                  `G'day ${BRAND}, I found your blog and need setup help.`
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#0a0a0c] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl border-2 border-[#FFCD00]"
              >
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full pb-20">
          <div className="bg-[#f2ebeb] rounded-3xl p-8 md:p-12 border-2 border-[#00843D]/20 text-center">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter text-[#0a0a0c] leading-tight mb-4">
              Ready to Stream <span className="text-[#00843D]">IPTV Australia?</span>
            </h3>
            <p className="text-[#0a0a0c]/70 text-sm sm:text-base font-medium max-w-xl mx-auto mb-8">
              Choose from 3, 6, or 12 month plans starting at AUD $55. Guided WhatsApp setup, 30,000+ channels, and 120,000+ movies and TV shows.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/pricing"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-lg border border-[#FFCD00]/30"
              >
                View IPTV Australia Plans <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                href="/setup"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#0a0a0c] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all border-2 border-[#00843D]"
              >
                Setup Guide
              </Link>
            </div>
