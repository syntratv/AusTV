...
// ✅ SAFE review stats — Australian numbers
...
export const metadata = generateSEOMetadata(
  `IPTV Australia Reviews | Verified Aussie Customer Feedback 2026`,
  `Read ${REVIEW_COUNT}+ verified IPTV Australia reviews from Aussie customers. Rated ${RATING_VALUE}/5 for 4K streaming, 30,000+ channels, and 24/7 support.`,
  '/reviews'
);

// ---------------------------------------------------------------------------
// COUNTRY FLAG COMPONENT (AU / US / UK / CA) — Australia First
// ---------------------------------------------------------------------------
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      // WebPage
      {
        ...
        description: `Verified reviews from Australian ${BRAND} customers.`,
        inLanguage: 'en-AU',
      ...
      // Single Product node
      {
        ...
        description: `${BRAND} delivers premium 4K live TV and on demand media across Australia with 99.9% server uptime and quick WhatsApp guided activation.`,
        sku: 'IPTV-AU-PREMIUM',
    ...
    <div className="flex gap-0.5">
      {[...Array(5)].map((_, i) => (
        <Star
          key={i}
          className={`${sizeClass} ${
            i < rating ? 'fill-[#FFCD00] text-[#FFCD00]' : 'text-[#0a0a0c]/20'
          }`}
        />
      ))}
    </div>
...
function ReviewCard({ review }: { review: (typeof reviews)[0] }) {
  ...
  return (
    <div className="relative bg-[#f2ebeb] border-2 border-[#00843D]/20 hover:border-[#00843D] rounded-3xl p-6 shadow-lg hover:shadow-[0_20px_50px_rgba(0,132,61,0.15)] hover:-translate-y-1.5 transition-all duration-500 flex flex-col">
      <Quote className="absolute top-4 right-4 w-12 h-12 text-[#00843D]/10 rotate-180" />

      <div className="flex items-start gap-3.5 mb-4">
        <div className="relative flex-shrink-0">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00843D] to-[#006A31] flex items-center justify-center text-[#FFFFFF] font-black text-base uppercase shadow-md">
            {initials}
          </div>
      ...
      <div className="pt-4 border-t border-[#0a0a0c]/10 flex items-center justify-between gap-2">
        <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-[#0a0a0c]/60">
          <PlayCircle className="w-3.5 h-3.5 text-[#00843D]" />
          {review.device}
        </span>
        <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider text-[#00843D]">
...
function FAQItem({ q, a }: { q: string; a: string }) {
  return (
    <details className="group bg-[#f2ebeb] border-4 border-[#00843D] rounded-2xl overflow-hidden">
      <summary className="cursor-pointer list-none p-6 flex items-center justify-between gap-4 hover:bg-[#f2ebeb]/80 transition-colors">
        <h3 className="text-base md:text-lg font-black uppercase tracking-tight text-[#0a0a0c] flex items-start gap-3 text-left">
          <span className="text-[#00843D] font-black text-xl shrink-0">Q.</span>
          <span>{q}</span>
        </h3>
        <ChevronDown className="w-5 h-5 flex-shrink-0 text-[#00843D] transition-transform duration-300 group-open:rotate-180" />
      </summary>
      <div className="px-6 pb-6">
        <p className="text-[#0a0a0c]/80 font-medium leading-relaxed text-sm md:text-base pl-9 border-l-4 border-[#00843D] ml-1 py-1">
          {a}
        </p>
      </div>
    </details>
      ...
      <div className="flex flex-col min-h-screen bg-[#0a0a0c] text-[#FFFFFF]">
        ...
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none text-[#FFFFFF] mb-6">
              IPTV AUSTRALIA <br />
              <span className="text-[#FFCD00]">REVIEWS & TESTIMONIALS</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl text-[#FFFFFF]/70 font-bold max-w-2xl mx-auto leading-relaxed mb-8">
              Read verified reviews from {HAPPY_CUSTOMERS} happy Aussie
              customers, from Sydney to Perth, rated{' '}
          ...
          <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-8 md:p-10 shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              <div className="text-center md:text-left">
                <div className="text-6xl md:text-7xl font-black text-[#00843D] leading-none mb-2">
                  {RATING_VALUE}
                </div>
              ...
              <div className="text-center border-y md:border-y-0 md:border-x border-[#0a0a0c]/10 py-6 md:py-0 md:px-8">
                <div className="inline-flex items-center justify-center gap-2 bg-[#00843D] text-[#FFCD00] px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-3">
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full mb-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[#FFFFFF] uppercase tracking-tighter leading-tight">
              What Aussies Are <span className="text-[#FFCD00]">Saying</span>
            </h2>
          </div>
            ...
            {[
              {
                icon: ShieldCheck,
                title: '99.9% Uptime',
                desc: 'Enterprise grade Australian servers',
              },
              {
                icon: Zap,
                title: '4K & 60FPS',
              ...
              return (
                <div
                  key={item.title}
                  className="bg-[#f2ebeb] border-2 border-[#00843D]/20 hover:border-[#00843D] rounded-2xl p-5 text-center transition-all duration-300"
                >
          ...
          <div className="relative rounded-3xl overflow-hidden border-2 border-[#FFCD00]/30 bg-gradient-to-br from-[#00843D] via-[#006A31] to-[#00843D] p-8 md:p-10 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[#FFFFFF]/90 text-sm sm:text-base font-bold max-w-xl mx-auto mb-6">
                Message our team on WhatsApp. We will set up IBO Player Pro for
                you and get you streaming in under 10 minutes.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a
                  href={`${WHATSAPP_BASE}?text=${encodeURIComponent(
                    `G'day! I read your reviews and I'd like to try the free 24 hour trial.`
                  )}`}
                  target="_blank"
                ...
                <Link
                  href="/pricing"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#FFCD00] text-[#006A31] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl"
                >
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full mb-16 relative">
          ...
          <div className="text-center mb-10 relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[#FFFFFF] uppercase tracking-tighter leading-tight">
              Common Questions{' '}
              <span className="text-[#FFCD00]">About Our Reviews</span>
            </h2>
          </div>
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full pb-20">
          <div className="bg-[#f2ebeb] rounded-3xl p-8 md:p-12 border-2 border-[#00843D]/20 text-center">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter text-[#0a0a0c] leading-tight mb-4">
              Ready to Join Our{' '}
              <span className="text-[#00843D]">Happy Customers?</span>
            </h3>
            <p className="text-[#0a0a0c]/70 text-sm sm:text-base font-medium max-w-xl mx-auto mb-8">
              Choose from 3, 6, or 12 month plans starting at AUD $55. Guided
              WhatsApp setup, 30,000+ channels, and 120,000+ movies and TV
              shows.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/pricing"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-lg border border-[#FFCD00]"
              >
