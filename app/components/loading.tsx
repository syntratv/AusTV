...
function LoaderContent() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] pointer-events-none" aria-hidden="true">
      ...
      <div className="h-1.5 w-full bg-[#0a0a0c]/60 overflow-hidden shadow-[0_0_18px_rgba(0,132,61,0.9)]">
        {/* Sliding shimmer gradient */}
        <div className="h-full w-full bg-gradient-to-r from-[#00843D] via-[#FFCD00] to-[#00662F] origin-left animate-[loadingShimmer_1.4s_ease-in-out_infinite]" />
      </div>
