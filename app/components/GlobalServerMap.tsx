...
export default function GlobalServerMap() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(0,132,61,0.1),_transparent_65%)] pointer-events-none" />
      ...
      <FadeIn className="relative z-10 mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-8 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-black uppercase leading-tight tracking-tight text-white sm:text-4xl md:text-5xl">
            Global Server Coverage In <span className="text-[#00843D]">100+ Countries</span>
          </h2>

          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/80 sm:text-base font-medium">
            Experience ultra-fast 4K IPTV streaming powered by {CONSTANTS.BRAND_NAME}&apos;s global network. Enjoy zero buffering, maximum stability, and guaranteed 99.9% uptime worldwide.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto text-center">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:border-[#00843D]/50 hover:shadow-[0_10px_30px_rgba(0,132,61,0.15)] transition-all duration-300">
            <div className="flex justify-center mb-3">
              <Zap className="h-6 w-6 text-[#00843D]" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:border-[#00843D]/50 hover:shadow-[0_10px_30px_rgba(0,132,61,0.15)] transition-all duration-300">
            <div className="flex justify-center mb-3">
              <Server className="h-6 w-6 text-[#00843D]" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:border-[#00843D]/50 hover:shadow-[0_10px_30px_rgba(0,132,61,0.15)] transition-all duration-300">
            <div className="flex justify-center mb-3">
              <ShieldCheck className="h-6 w-6 text-[#00843D]" />
            </div>
