...
const faqList: FAQItem[] = [
  // GENERAL
  { id: 'gen-1', category: 'general', q: 'What is IPTV and how is it different from traditional cable TV?', a: 'IPTV stands for Internet Protocol Television. Instead of a coax cable, fibre receiver, or satellite dish from traditional providers, the TV signals are streamed directly over your internet connection. This means no physical cable box is needed. You can watch thousands of channels in Full HD and 4K anywhere in Australia with just an internet connection.' },
  { id: 'gen-2', category: 'general', q: 'How fast will I get set up after payment?', a: 'Once you confirm your plan and complete payment, our team handles the setup with you live on WhatsApp. We send your login details, walk you through installing a player like IBO Player Pro, and send the test content, all in the same chat. Most customers are streaming within 10 minutes.' },
  { id: 'gen-3', category: 'general', q: 'Can I watch on multiple TVs or screens at the same time?', a: 'Yes, depending on your plan. You can pick 1, 2, or 3 simultaneous screens during checkout. That means multiple household members can watch different things at the same time without any interruption.' },
  { id: 'gen-4', category: 'general', q: 'How does the free trial work?', a: 'Message us on WhatsApp and we will set you up with a free 24 hour trial so you can test the 4K picture quality, check the sport and movie lineup, and make sure everything runs smooth on your own device and internet connection. Upgrade to a paid plan only when you are happy.' },
  ...
  { id: 'gen-6', category: 'general', q: 'Can I test the service before I pay?', a: 'Yes, that is exactly how we do things. Contact our WhatsApp support team and we will give you a free 24 hour trial so you can see the picture quality on your own TV before you commit to a subscription.' },

  // SPORTS
  { id: 'sport-1', category: 'sports', q: 'Are Fox Footy, Optus Sport, and Cricket Australia included?', a: 'Yes. Every channel package includes the complete Australian sport lineup in smooth 60FPS quality. Watch the AFL, NRL, Cricket Australia summer series, Super Rugby, Formula 1, and major fight nights, all included.' },
  { id: 'sport-2', category: 'sports', q: 'Do I pay extra for UFC or Boxing PPV events?', a: 'No, all worldwide Pay Per View events are included by default. This covers numbered UFC Main Cards, Championship Boxing, WWE events, AEW, and major MMA events at no additional cost.' },
  { id: 'sport-3', category: 'sports', q: 'Do foreign movies and series have English subtitles?', a: 'Over 95% of our complete VOD catalog, more than 120,000 movies and TV shows from Netflix, HBO Max, Disney Plus, and cinema releases, includes selectable English subtitles and optional original audio tracks.' },
  { id: 'sport-4', category: 'sports', q: 'Does the EPG TV guide and catch up feature work properly?', a: 'Yes. Our interactive EPG TV guide is synced automatically every 6 hours with current programming. For major Australian, US, UK, and international channels, a 7 day catch up and replay feature is available.' },
  ...
  { id: 'sport-6', category: 'sports', q: 'How stable is the picture quality during popular sport events?', a: 'Our servers use dynamic load balancing through dedicated Sydney and Melbourne data centres. Even during peak moments like AFL grand final day, State of Origin, or a major UFC title fight, the bitrate stays stable without frame drops.' },
  ...
  { id: 'dev-3', category: 'devices', q: 'What minimum internet speed do I need for 4K and 60FPS?', a: 'For Full HD channels we recommend at least 15 to 20 Mbps. For 4K Ultra HD and 60FPS sport streams, 25 to 30 Mbps. A wired Ethernet cable or 5GHz Wi-Fi network always provides the most stable experience.' },
  ...
  { id: 'dev-5', category: 'devices', q: 'Do I need technical skills to complete the installation?', a: 'No. Installation takes less than 5 minutes on average, and our team walks you through it on WhatsApp. You download a player app from your device store, enter the login details we send you, and the channels load automatically.' },
  { id: 'dev-6', category: 'devices', q: 'Can I use my account while travelling outside Australia?', a: 'Yes. Our streams are accessible worldwide without geographic restrictions. You can use your IPTV Australia account worry free in your holiday home in Bali, Europe, or anywhere else.' },

  // BILLING
  { id: 'pay-1', category: 'billing', q: 'What secure payment options do you support?', a: 'You can pay safely via PayID, Credit Card (Visa and Mastercard), PayPal, and cryptocurrencies (Bitcoin, USDT, Ethereum) through a heavily secured 256 bit SSL connection. All prices are in AUD $.' },
  ...
  { id: 'pay-3', category: 'billing', q: 'How is my personal data protected?', a: 'We respect the Australian Privacy Act and international data protection standards. We never store viewing history or channel logs, never sell data to third parties, and never retain credit card or bank account numbers on our local servers.' },
    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0c] text-[#FFFFFF] overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 border-b border-white/5 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-[#00843D]/15 blur-[140px] rounded-full" />
          <div
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center justify-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#FFFFFF] tracking-tighter uppercase mb-6 leading-none">
            ...
            <span className="text-[#FFCD00]">QUESTIONS</span>
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-[#FFFFFF]/70 font-bold max-w-2xl mx-auto leading-relaxed mb-8">
            Find instant answers about <span className="text-[#FFCD00]">IPTV Australia</span> subscriptions, 4K streaming, Smart TV setup, and secure AUD payments.
          </p>

          {/* Flag row — Australia First */}
          ...
          <div className="w-full max-w-xl relative mt-2 group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#00843D] to-[#006A31] rounded-full blur opacity-30 group-hover:opacity-60 transition-opacity duration-300" />
            <div className="relative">
              <Search className="w-5 h-5 text-[#00843D] absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none z-10" />
              <input
                type="text"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                placeholder="Search a question (Fox Footy, IBO Player, PayID, buffering)..."
                className="w-full pl-12 pr-4 py-4 rounded-full bg-[#f2ebeb] text-[#0a0a0c] placeholder-[#0a0a0c]/50 font-bold border-2 border-transparent focus:border-[#00843D] focus:outline-none shadow-2xl transition-all"
              />
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-12">
          {[
            ...
            { id: 'sports', label: 'Sport & Channels', icon: Zap },
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-black uppercase tracking-wider transition-all duration-200 cursor-pointer shadow-md border-2 ${
                  active
                    ? 'bg-[#00843D] text-[#FFFFFF] border-[#00843D] scale-105 shadow-lg shadow-[#00843D]/30'
                    : 'bg-white/5 text-[#FFFFFF]/70 border-white/10 hover:border-[#00843D] hover:text-[#FFFFFF] hover:scale-105'
                }`}
              >
        ...
        {filteredFaqs.length > 0 ? (
              ...
              return (
                <div
                  ...
                  className={`group relative bg-[#f2ebeb] rounded-2xl sm:rounded-3xl overflow-hidden border-2 transition-all duration-300 ${
                    isOpen
                      ? 'border-[#00843D] shadow-[0_20px_50px_rgba(0,132,61,0.2)]'
                      : 'border-[#00843D]/20 hover:border-[#00843D] hover:shadow-[0_15px_35px_rgba(0,132,61,0.12)]'
                  }`}
                >
                  {/* Left accent bar when open */}
                  <div
                    className={`absolute left-0 top-0 bottom-0 w-1.5 transition-all duration-300 ${
                      isOpen ? 'bg-[#00843D]' : 'bg-transparent'
                    }`}
                  />
                  ...
                  >
                    <div className="flex items-start gap-3 pr-2 flex-1">
                      <span
                        className={`shrink-0 w-7 h-7 rounded-lg flex items-center justify-center transition-colors ${
                          isOpen ? 'bg-[#00843D] text-[#FFFFFF]' : 'bg-[#00843D]/10 text-[#00843D]'
                        }`}
                      >
                    ...
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 ${
                        isOpen
                          ? 'rotate-180 bg-[#00843D] text-[#FFFFFF]'
                          : 'bg-[#0a0a0c]/5 text-[#0a0a0c] group-hover:bg-[#00843D]/10 group-hover:text-[#00843D]'
                      }`}
                    >
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="text-[#0a0a0c]/85 text-sm sm:text-base font-medium leading-relaxed px-5 sm:px-6 pl-15 sm:pl-16 border-l-4 border-[#00843D] ml-4 sm:ml-5 py-1">
                        {faq.a}
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-10 text-center shadow-xl">
            <AlertCircle className="w-10 h-10 text-[#00843D] mx-auto mb-3" />
            ...
            <a
              href={`${whatsappBaseUrl}?text=${encodeURIComponent(`G'day ${BRAND}, I could not find an answer to my question.`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-xs uppercase tracking-widest hover:bg-[#006A31] transition-all shadow-lg border border-[#FFCD00]/30"
            >
      ...
      <section className="py-16 bg-[#0a0a0c] border-y border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-[#00843D]/10 border border-[#00843D]/30 px-4 py-1.5 rounded-full mb-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#FFFFFF] uppercase tracking-tight mb-3">
              Best <span className="text-[#FFCD00]">Devices & Apps</span>
            </h2>
            <p className="text-sm sm:text-base text-[#FFFFFF]/70 font-bold max-w-xl mx-auto">
              The best IPTV players and minimum internet speeds for a buffer free viewing experience in Australia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div
                  key={card.title}
                  className="group bg-[#f2ebeb] border-2 border-[#00843D]/30 rounded-2xl p-6 flex flex-col justify-between hover:border-[#00843D] hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,132,61,0.2)] transition-all duration-500"
                >
                  <div>
                    <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center mb-4 group-hover:bg-[#00843D] transition-colors">
                      <Icon className="w-6 h-6 text-[#00843D] group-hover:text-[#FFFFFF] transition-colors" />
                    </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#0a0a0c]/10 text-[11px] font-black text-[#00843D]">
                    {card.speed}
                  </div>
                </div>
              );
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-8 sm:p-10 shadow-2xl">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-[#00843D] flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.n} className="p-5 bg-white rounded-2xl border border-[#0a0a0c]/10 shadow-sm">
                <span className="w-8 h-8 rounded-full bg-[#00843D] text-[#FFFFFF] font-black text-sm flex items-center justify-center mb-3">
                  {step.n}
                </span>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 w-full">
        <div className="relative rounded-3xl overflow-hidden border-2 border-[#FFCD00]/30 bg-gradient-to-br from-[#00843D] via-[#006A31] to-[#00843D] p-8 md:p-12 text-center shadow-2xl">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-[#FFCD00] text-[#006A31] px-4 py-2 rounded-full mb-4 shadow-md">
            ...
            <p className="text-[#FFFFFF]/90 font-bold text-sm sm:text-base max-w-xl mx-auto mb-8 leading-relaxed">
              Our team is available 24/7 on WhatsApp for installation help, channel questions, and free 24 hour trial lines.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
              <a
                href={`${whatsappBaseUrl}?text=${encodeURIComponent(`G'day ${BRAND}, I have a question about the IPTV Australia service.`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#0a0a0c] text-[#FFFFFF] font-black text-xs uppercase tracking-widest hover:bg-[#FFFFFF] hover:text-[#00843D] transition-all hover:scale-105 shadow-xl border-2 border-[#FFCD00]"
              >
                <MessageCircle className="w-4 h-4" /> WhatsApp Support
              </a>
              <Link
                href="/pricing"
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#FFCD00] text-[#006A31] font-black text-xs uppercase tracking-widest hover:scale-105 transition-transform shadow-xl"
              >
                View All Plans
              </Link>
            </div>
