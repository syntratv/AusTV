...
export const metadata = generateSEOMetadata(
  ...
  `Read how ${BRAND} safeguards your privacy and personal data in compliance with the Australian Privacy Act, GDPR (EU), and CCPA (California). 100% confidential.`,
  '/privacy'
);
    ...
    '@graph': [
      {
        ...
        description: `${BRAND} privacy policy. How we collect, protect, and manage your personal data in compliance with the Australian Privacy Act, GDPR, and CCPA.`,
        inLanguage: 'en-AU',
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 w-full">
          ...
          <div className="flex gap-4 items-start">
            <div className="flex-shrink-0">
              <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center">
                <Lock className="w-6 h-6 text-[#00843D]" />
              </div>
            </div>
            <div>
              <p className="text-[#0a0a0c] font-bold text-sm md:text-base leading-relaxed">
                ...
                We treat your data with strict confidentiality in full compliance with the Australian Privacy Act 1988, the EU GDPR, and the California CCPA. We never store viewing history, and we never sell your data to third parties under any circumstances.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-10">
              ...
              <div className="flex gap-4 items-start">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 rounded-xl bg-[#00843D]/10 flex items-center justify-center">
                    <Eye className="w-5 h-5 text-[#00843D]" />
                  </div>
                </div>
                <div>
                  <p className="text-[#0a0a0c] text-sm font-bold leading-relaxed">
                    ...
                    We do not record viewing behaviour, channel selections, searches, or specific stream logs. Your streaming activity is and remains 100% private.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <ul className="space-y-3 mb-6">
              {[
                'Activating and configuring your subscription details and IBO Player Pro setup.',
                'Securely processing transactions and billing in Australian dollars.',
                ...
                'Maintaining server stability and preventing unauthorised misuse.',
              ].map((item, idx) => (
                <li
                  key={idx}
                  className="flex items-start gap-3 text-[#FFFFFF]/80 font-bold text-sm md:text-base"
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed mb-4">
              {BRAND} employs advanced technical and organisational security measures to protect your data:
            </p>
            <ul className="space-y-3 mb-6">
              {[
                ...
                'Strict access controls: only authorised technical staff have access to support data.',
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed">
              We use only functional and anonymised analytical cookies to optimise website loading speed and remember your language preference. You can disable cookies at any time through your web browser settings.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-[#FFFFFF] uppercase tracking-tight mb-4 flex items-center gap-3">
              <span className="w-2 h-7 bg-[#00843D] rounded-full inline-block" />
              5. Your Rights Under Australian Privacy Act, GDPR & CCPA
            </h2>
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed mb-4">
              Depending on your jurisdiction (Australia, EU, or California), you have the following legal privacy rights:
            </p>
            <ul className="space-y-3 mb-6">
              {[
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed">
              We retain your account and contact information only for as long as your subscription remains active, plus a reasonable period thereafter for legal, tax, and accounting purposes. After that period, all personal data is securely deleted or anonymised.
            </p>
          </section>
          ...
          {/* Section 10 — Updates */}
          <section>
            <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-6 md:p-8 shadow-xl">
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center flex-shrink-0">
                  <FileText className="w-6 h-6 text-[#00843D]" />
                </div>
                <div>
                  <p className="text-[#00843D] font-black uppercase tracking-wider text-sm mb-1">
                    Policy Updates
                  </p>
                  <p className="text-[#0a0a0c] font-bold text-sm md:text-base leading-relaxed">
