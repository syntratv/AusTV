      ...
      <section className="relative pt-32 pb-16 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10 flex flex-col items-center justify-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-[#FFFFFF] uppercase tracking-tighter leading-none mb-6">
            DMCA <span className="text-[#FFCD00]">Policy</span>
          </h1>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <p className="text-[#0a0a0c] font-bold text-sm md:text-base leading-relaxed">
                ...
                {BRAND} does not host, upload, or manage any media files on its own servers. Our software exclusively indexes and organises publicly available streams and playlists on the internet.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed mb-4">
              It is essential to emphasise that <strong className="text-[#FFFFFF]">{BRAND}</strong> does not broadcast, store, or host any streaming media, video files, or TV broadcasts on its own hardware.
            </p>
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed">
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed">
              If you believe that your content was removed in error or misidentification, you may submit a counter notification to our copyright department at <a href={`mailto:dmca@${CONSTANTS.DOMAIN}`} className="text-[#FFCD00] font-black hover:underline">dmca@{CONSTANTS.DOMAIN}</a>. Your counter notice must comply with the requirements of 17 U.S.C. § 512(g)(3), the Australian Copyright Act 1968, and any other applicable law, and must include your consent to the jurisdiction of the appropriate court.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#FFFFFF]/80 text-base font-medium leading-relaxed">
              For all copyright and DMCA related matters, please contact us at <a href={`mailto:dmca@${CONSTANTS.DOMAIN}`} className="text-[#FFCD00] font-black hover:underline">dmca@{CONSTANTS.DOMAIN}</a>. For general customer support, use our 24/7 <Link href="/support" className="text-[#FFCD00] font-black hover:underline">WhatsApp support team</Link>.
            </p>
          </section>
            ...
            <div className="bg-[#f2ebeb] border-4 border-[#00843D] rounded-3xl p-6 md:p-8 shadow-xl">
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-xl bg-[#00843D]/10 flex items-center justify-center flex-shrink-0">
                  <Copyright className="w-6 h-6 text-[#00843D]" />
                </div>
                <div>
